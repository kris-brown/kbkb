\begin{itemize}
    \item  Let $P \xrightarrow{f} \mathbb{B}$ be a \href{doc/1 math/Seven Sketches in Compositionality/1 Generative Effects/4 Monotone maps}{monotone map}. The subset $f^{-1}(true)$ is an \href{doc/1 math/Seven Sketches in Compositionality/1 Generative Effects/3 Preorders/Upper set}{upper set}. \begin{itemize}
