...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Use the following \ref{Functor|functor|referenced} $F$: \begin{tikzcd}\overset{Arr}\bullet \arrow[red,d, "tar", bend left] \arrow[blue,d, "src"', bend right] &\overset{State}\bullet \arrow[red, loop below, "next"] \\\overset{Vert}\bullet&\end{tikzcd}
          \begin{itemize}
