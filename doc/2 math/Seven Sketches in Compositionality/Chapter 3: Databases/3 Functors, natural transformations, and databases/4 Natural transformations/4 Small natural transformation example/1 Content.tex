...
\begin{itemize}
    ...
    \item The \ref{Natural transformation|natural transformation|referenced} requires us to choose morphisms in the righthand category for each object in the lefthand category
