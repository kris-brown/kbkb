...
\begin{document}
 ...
 \href{doc/phil/People/Sellars.html}{Up} 

 \href{doc/phil/People/Sellars/Quotes.pdf}{PDF} 
\title{Quotes}

\tableofcontents

\part{doc/phil/People/Sellars/Quotes/Againstphenomenalism.html|Against phenomenalism}
...
\part{doc/phil/People/Sellars/Quotes/Community.html|Community}
...
\part{doc/phil/People/Sellars/Quotes/Describingandexplaining.html|Describing and explaining}
...
\end{itemize}
\part{doc/phil/People/Sellars/Quotes/Describingtheworldwithoutmodality.html|Describing the world without modality}
...
\begin{itemize}
    ...
    \item He wants to say modal expressions and normative expression belong in
          a box.
\end{itemize}
\part{doc/phil/People/Sellars/Quotes/Exemplification.html|Exemplification}
...
\part{doc/phil/People/Sellars/Quotes/Issemanticspsychological.html|Is semantics psychological}
...
\part{doc/phil/People/Sellars/Quotes/Judgmentintheorderofexplanation.html|Judgment in the order of explanation}
...
\part{doc/phil/People/Sellars/Quotes/LabelingvsDescribing.html|Labeling vs Describing}
...
\end{itemize}
\part{doc/phil/People/Sellars/Quotes/Manasrationalanimal.html|Man as rational animal}
...
\part{doc/phil/People/Sellars/Quotes/Modalexpressionsasexplanations.html|Modal expressions as explanations}
...
\part{doc/phil/People/Sellars/Quotes/Modalitiesandnorms.html|Modalities and norms}
...
\part{doc/phil/People/Sellars/Quotes/Nondescriptiveconcepts.html|Nondescriptive concepts}
...
\end{itemize}
\part{doc/phil/People/Sellars/Quotes/Rulesarelived.html|Rules are lived}
...
\part{doc/phil/People/Sellars/Quotes/ScientiumMensura.html|Scientium Mensura}
...
\part{doc/phil/People/Sellars/Quotes/SpaceofReasons.html|Space of Reasons}
``In characterizing an episode or a state as \emph{knowing}, we are not giving an empirical description of it. We are placing it in the logical space of reasons, of justifying and being able to justify what one says." \cite{sellars1956empiricism}
    ...
    \end{itemize}
\part{doc/phil/People/Sellars/Quotes/Subjunctiveconditionalsasessential.html|Subjunctive conditionals as essential}
...
\part{doc/phil/People/Sellars/Quotes/Transitiontoconceptualthinking.html|Transition to conceptual thinking}
